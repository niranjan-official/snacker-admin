...
const ProductBlock = ({
  ...
  return (
    <div className="relative flex w-full gap-3 rounded-lg bg-white p-3 shadow">
      <div className="flex aspect-square w-[50%] justify-center bg-zinc-100">
        <Image
          src={product.imgSrc}
          width={80}
          height={80}
      ...
      <div className="flex w-full flex-col">
        ...
        <div className="mt-2 flex items-center gap-5">
          <span className="bg-neutral-100 p-1">stock: {product.stock}</span>
          <span className="bg-neutral-100 p-1">
